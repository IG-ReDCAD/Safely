"""Fill the tabels with data from a csv file

This file is used to fill the tables with data
"""
...
def loadCategory():
    ...
    for index in range(total_rows):
        ...
        # if category_name_row != "nan" and category_name_row != "NaN" :
...
def updateNeigh():
    ...
    for index in range(len(list_names)):
        ...
        # crime_instance=Crime.query.filter(Crime.latitude==float(list_lat[index])).first()
        # print(crime_instance)
        # print(crime_instance)
        # r=crime_instance=Crime.query.filter(Crime.latitude==float(list_lat[index])).first()
            ...
            if item.latitude == float(list_lat[index]) and item.longitude== float(list_lng[index]):
                ...
                for item_neigh in neigh_instance:
                    if item_neigh.neigh_id == item.neighborhood_id:
                        ...
                        # print(item_neigh.neigh_id, item_neigh.neigh_name, list_names[index])
